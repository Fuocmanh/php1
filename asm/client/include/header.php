            ...
            <ul>
                ...
                ?>
                    ...
                    <li><a style="font-size:16px; margin-left:0px !important;" href="SignUp.php">Sign Up</a>/<a style="font-size:16px;margin-left:0px !important;" href="LogIn.php">Log in</a>
                        <br>
                        <from action="products.php" method="POST" style="height:28px;display:flex; margin-left:-50px !important">
                            <input  type="text" name="key" style="height:28px;  margin:0 1px;" onchange="this.form.submit()">
                            <button type="submit" name="search" style="background-color:black; width: 28px; height:28px; position: relative; border-radius:5px;color:white;" >
                ...
                <?php
                    ...
                    <li style=" font-size: 16px; ">
                        ...
                        <from action="products.php" method="POST" style="height:28px;display:flex; margin-left:-50px !important">
                            <input type="text" name="key" style="height:28px;  margin:0 1px;"  onchange="this.form.submit()">
                            <button type="submit" name="search" style="background-color:black; width: 28px; height:28px; position: relative; border-radius:5px;color:white;"><svg style="margin-top:-5px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                    <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                                </svg></button>
                        </from>
                    </li>
