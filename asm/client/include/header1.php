    ...
    <section class="menu-logo">
            ...
            <ul class="dropdownn">
                <li class="dropbtn" id="logo">
                    ...
                    <ul class="dropdown-content">
                        ...
                        <li>
                            <a href="./client/aboutus.php">About us</a>
                        </li>
                        <li>
                            <a href="./client/contact.php">Contact us</a>
                        </li>
                        <li>
                            <a href="./client/Cart.php"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cart2" viewBox="0 0 16 16">
        ...
        <nav class="n">
            <ul>
                ...
                <li><a style="font-size:16px; margin:0px !important;" href="client/SignUp.php">Sign Up</a>/<a style="font-size:16px;margin-left:0px !important;" href="client/LogIn.php">Log in</a>
                    <br>
                    <from style="height:28px;display:flex; margin-left:-50px !important">
                        <input name="search" style="height:28px;  margin:0 1px;" type="text">
                        <button style="width: 28px; height:28px; position: relative; border-radius:5px;" type="submit" name="submit">
            ...
            <?php
                ...
                <li ><a style="font-size:16px;margin:0px;" href="client/list-bill.php"><?= $_SESSION['user'] ?></a><a href="client/logout.php" style="margin:0px;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
