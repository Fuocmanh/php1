...
if (isset($_POST['logad'])) {
  ...
  // lấy db
  $get= "SELECT email,pass FROM `admin` WHERE email = '$email' AND pass = '$pass'";
  ...
  <?php
    ...
    <body style="background-color:black;">  
      <main class="h-full pb-16 overflow-y-auto" >
        <div class="container flex flex-col items-center px-6 mx-auto" >
          ...
          Username or password does not match,check please and
            <a
    ...
    <?php
      // echo'Username or password does not match, please re-enter';
  endif;
}
else{
