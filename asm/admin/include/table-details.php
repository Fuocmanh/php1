...
<a href="module/pages/add-det.php" class="button">
            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                ...
                ?>
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <p class="font-semibold"><?= $de['details'] ?></p>
                            </td>
                            <td class="px-4 py-3 text-sm">
                            <p class="font-semibold"><?= $de['color'] ?></p>
                            </td>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    ...
                                    <a href="module/action/del-details-action.php?id=<?= $de['det_id']; ?>" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Delete">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
