    ...
    <div class="flex flex-col flex-1 w-full">
      ...
      <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto">
          ...
          <!-- With avatar -->
          <?php
           include('include/table-user.php');
           include('include/table-style.php');
           include('include/table-products.php');
           include('include/table-details.php');
           include('include/table-img.php');
          ?>
